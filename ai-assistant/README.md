...
3. Open the `ai-assistant/index.js` file and update the values of the `LICENSE_KEY`, `AI_OPENAI_API_URL`, `AI_OPENAI_TOKEN`, `AI_OPENAI_MODEL`, and `CKBOX_TOKEN_URL` variables. Without this, the CKBox, AIAssistant and other premium features will not be enabled.
